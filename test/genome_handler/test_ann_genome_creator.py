...
class TestAnnGenomeCreator(unittest.TestCase):
    ...
    def test_create_type(self):
        file_path = os.path.join(bed_file_prefix,'one_plus_strand_all_utr_5.bed')
    ...
    def test_two_seq_on_same_plus(self):
        file_path = os.path.join(bed_file_prefix,'two_seq_on_same_plus_strand.bed')
        real_genome = TestAnnGenomeCreator.real_genome.two_seq_on_same_plus_strand(False)
        result = _create_genome(file_path)
        self._test_genome(real_genome,result)

    def test_one_plus_strand_both(self):
        file_path = os.path.join(bed_file_prefix,'one_plus_strand_both_utr.bed')
    ...
    def test_multiple_utr_intron_cds(self):
        file_path = os.path.join(bed_file_prefix,'multiple_utr_intron_cds.bed')
