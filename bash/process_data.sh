...
python3 $preprocess_root/convert_bed_id.py -i $gene_bed_path -t $id_convert_table_path -o $gene_bed_path
python3 $preprocess_root/remove_coordinate_duplicated_bed.py -i $gene_bed_path -o $gene_bed_path
...
python3 $preprocess_root/get_subbed.py -i $rna_bed_path -d $region_selected_root/selected_gene.id \
...
python3 $preprocess_root/alt_anns_creator.py -i $result_root/alt_region.gff \
