...
#if [ ! -e "$saved_root/with_strand_rna_stats/gff_analysis.log" ]; then
    #echo "run rna"
    bash  $bash_root/gff_analysis.sh -i $rna_gff_path -f $region_fasta_path -o $saved_root/with_strand_rna_stats \
    -r $region_table_path -s ordinal_id_with_strand
#fi

#if [ ! -e "$saved_root/with_strand_canonical_stats/gff_analysis.log" ]; then
    #echo "run gene"
    bash  $bash_root/gff_analysis.sh -i $canonical_gff_path -f $region_fasta_path -o $saved_root/with_strand_canonical_stats \
    -r $region_table_path -s ordinal_id_with_strand
#fi
