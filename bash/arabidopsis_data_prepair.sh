...
usage(){
 ...
 echo "Example: bash arabidopsis_data_prepair.sh -r /home/io/Arabidopsis_thaliana -o ./data/2019_07_12"
 echo ""
}
...
pac_path="$root/raw_data/arabidopsis_thaliana.Seedling_Control_(SRP089899).all.PAC.bed"
...
python3 $preprocess_main_root/process_GRO_and_PAC.py --output_root $saved_root --gro_1 $gro_1 \
