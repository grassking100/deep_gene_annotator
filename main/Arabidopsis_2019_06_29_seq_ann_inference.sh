...
python_script_path=$script_root/Arabidopsis_2019_06_29_seq_ann_inference.py
...
max_len=10000
test_chroms='5'
saved_root='./io/record/arabidopsis_2019_06_29'
mkdir -p $saved_root
mkdir -p $saved_root/seq_ann_inference

python3 $python_script_path 0 $fasta_path $ann_seqs_path $max_len '1,2,3' '4' $test_chroms $saved_root/seq_ann_inference/fold_1
