...
def remove_coordinate_duplicated_bed(bed):
    bed['coord_id'] = bed['chr'].astype(str)+bed['start'].astype(str)+bed['end'].astype(str)+bed['strand'].astype(str)
...
if __name__ == "__main__":
    #Reading arguments
    parser = ArgumentParser(description="This program will remove duplicated coordinate data, but preserve all id")
