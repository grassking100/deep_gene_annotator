...
class PathHelper:
    def __init__(self,raw_data_root,processed_root):
        ...
        self.region_table_path = os.path.join(raw_data_root,'processed/result/region_rename_table_double_strand.tsv')
    ...
    def get_length_log10_model_path(self,trained_id,usage=None):
        name = self.get_file_name(trained_id,usage)
        path = os.path.join(self.split_root,"length_gaussian",name,"length_log10_gaussian_model.tsv")
        return path
