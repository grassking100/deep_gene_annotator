...
def main(input_bed_path,id_table_path,output_root,non_hypothetical_protein_gene_id_path=None,
    ...
    if remove_fail_score_gene:
        score_bed = gene_score_filter(bed,score_threshold,score_mode,id_convert_dict)
    else:
    ...
    intersection_ids = intersection(transcript_ids_list,transcript_names_list,
                                    ...
                                    venn_path=ven_path)
    filtered_bed = get_subbed(bed,intersection_ids)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--score_mode",type=str,default='bigger_or_equal')
