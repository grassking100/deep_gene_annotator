...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--input_path",help="Path of gff or bed file to renamed chromosome",required=True)
    parser.add_argument("-t", "--table_path",help="Table about renamed region",required=True)
    parser.add_argument("-o", "--output_path",help="Path to saved renamed file",required=True)
