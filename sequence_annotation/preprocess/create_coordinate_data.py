...
from sequence_annotation.utils.utils import read_gff,get_gff_with_updated_attribute,get_gff_with_attribute,write_gff
...
if __name__ == "__main__":
    ...
    if os.path.exists(args.output_path):
        ...
        #print(list(plus_valid_order)+list(minus_valid_order))
