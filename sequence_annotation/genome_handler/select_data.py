...
def select_data_by_length(
        fasta, ann_seqs, min_len=None, max_len=None, ratio=None):
...
def select_data_by_length_each_type(
        fasta, ann_seqs, min_len=None, max_len=None, ratio=None):
    ...
    fasta_list = [
        ...
        no_region_fasta]
    ann_list = [
        multiple_exon_region_anns,
        single_exon_region_anns,
        no_region_anns]
