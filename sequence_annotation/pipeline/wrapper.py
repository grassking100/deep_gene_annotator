...
def fit_generator_wrapper_generator(batch_size=32,epoch_shuffle=False,*args,**argws):
...
def evaluate_generator_wrapper_generator(batch_size=32,epoch_shuffle=False,*args,**argws):
