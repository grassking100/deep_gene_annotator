...
class TrainWorker(Worker):
    ...
    def _get_addition_callbacks(self):
        ...
        if self._val_x is None and self._val_y is None:
            ...
            if self._use_generator:
                valdata = self._preparedata(self._val_x,self._val_y,self._batch_size)
            else:
    ...
    def before_work(self):
        ...
        self._processdata()
    def _preparedata(self,xdata,ydata,batch_size):
    ...
    def _train_by_generator(self):
        if self._val_x is None and self._val_y is None:
            ...
            raise Exception("Data is missing")
        val_data = self._preparedata(self._val_x,self._val_y,self._batch_size)
        train_data = self._preparedata(self._train_x,self._train_y,self._batch_size)
