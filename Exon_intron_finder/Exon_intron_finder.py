...
def Exon_intron_finder_factory(convolution_settings=[], LSTM_layer_number=1,add_terminal_signal=True,add_batch_normalize=False):
    ...
    #add lstm rnn layer#  
    lstm_forward=LSTM(LSTM_layer_number,return_sequences=True ,activation='tanh',name='Lstm_forward')(previous_layer)
    lstm_backword=LSTM(LSTM_layer_number,return_sequences=True ,go_backwards=True,activation='tanh',name='Lstm_backword')(previous_layer)
    ####################
