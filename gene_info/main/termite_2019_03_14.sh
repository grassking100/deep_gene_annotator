...
coordinate_bed=${saved_root}/transdecoder_complete_cds_align_to_termite_g1_2018_9_7_Ching_Tien_Wang_merged_with_coordinate_file
coordinate_consist=${saved_root}/transdecoder_complete_cds_align_to_termite_g1_2018_9_7_Ching_Tien_Wang_merged_with_coordinate_file
...
mRNA_file=${saved_root}/result/mRNA_coordinate
exon_file=${saved_root}/transdecoder_complete_cds_align_to_termite_g1_2018_9_7_Ching_Tien_Wang_CDS
dist_to_5=500
dist_to_3=500
TSS_radius=200
donor_radius=200
